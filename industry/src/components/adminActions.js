...
const AdminActions = ({history}) => (<div className="container actionbuttons">
  ...
  <div className="row justify-content-center d-flex">
    <div className="col-6">
      <button type="button" className="btn btn-block btn-secondary" onClick={() => history.push('/newProject')}>Add Project</button>
    </div>
    <div className="col-6">
