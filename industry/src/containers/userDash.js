...
class UserDash extends Component {
  ...
  projectLogin = async (e) => {
    ...
    await axios.post(`${devURL}/api/login/project/${input}`, { user_id:this.state.empID })
    .then(result => {
      ...
      <div className="container dashboard">
        <div className="row justify-content-between">
          ...
          <div className="col-5 d-flex align-items-center">
            <ActionButtons
              ...
              endProject={this.handleOpenLogOut}
        ...
        <div className="row justify-content-end">
          <div className="col-3 d-flex justify-content-between">
            ...
            <button type="button" className="btn btn-warning" onClick={this.clockOut} disabled={this.state.projects.length ? "disabled": ""}>Clock Out</button>
          </div>
        </div>
        <div className="container">
          <ReactModal
            isOpen={this.state.showModal}
            contentLabel="Login Project"
            onRequestClose={this.handleCloseModal}
            >
              <ProjectLogin
              send={this.projectLogin}
        ...
        <div className="container">
          <ReactModal
            ...
            contentLabel="Logout Project"
            onRequestClose={this.handleCloseLogOut}
            >
              <ProjectLogout
                logOut={this.logOutProject} handleProject={this.handleProject} projectID={this.state.projectID} handleClaimParts={this.handleClaimParts} claimParts={this.state.claimParts} handleScrap={this.handleScrap} scrap={this.state.scrap} handleCloseLogOut={this.handleCloseLogOut}
              />
          </ReactModal>
        </div>
      </div>
